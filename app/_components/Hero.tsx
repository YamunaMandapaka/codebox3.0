        ...
        <div className='w-full relative h-screen overflow-hidden '>
            ...
            <div className='absolute w-full flex flex-col items-center mt-24'>
                ...
                <h2 className='font-bold text-7xl font-game text-yellow-400 
                  ...
                  '>Coding Adventure</h2>
                <h2 className='mt-5 font-game text-2xl'>Beginner friendly coding courses and projects</h2>
                <Button className='font-game text-2xl p-5 mt-7' variant={'pixel'}>GET STARTED</Button>
            </div>
        </div>
